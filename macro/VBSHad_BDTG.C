...
void VBSHad_BDTG(
  ...
  TMVA::DataLoader *dataloader=new TMVA::DataLoader("MitHadAnalysis");
    ...
    TCut cutTrainBkg    = "ana_category == 1 && (mc > 50 && mc != 202 && mc < 500) && evt % 3 != 0";
    TCut cutTestSignal  = "ana_category == 1 && mc == 1 && evt % 3 == 0";
    TCut cutTestBkg     = "ana_category == 1 && (mc > 50 && mc != 202 && mc < 500) && evt % 3 == 0";
    
    TCut cutTrainQCDBkg   = "ana_category == 1 && mc == 500 && evt % 3 != 0";
    TCut cutTestQCDBkg    = "ana_category == 1 && mc == 500 && evt % 3 == 0";
