...
int Looper::AddSmear(string name){
	...
	if (name == "Tau21SCALE"){ SmearTau21Scale *s = new SmearTau21Scale(); systs_ . push_back(s); return 0;}
	if (name == "Tau32SCALE"){ SmearTau32Scale *s = new SmearTau32Scale(); systs_ . push_back(s); return 0;}
