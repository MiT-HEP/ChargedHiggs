...
def FindDataset(name,mount=""): 
    ...
    if mount =="":
        ...
        for i in range(0,len(o)):
         ...
         fileList=[ 'root://xrootd-cms.infn.it//'+str(x) for x in check_output(cmd,shell=True).split() ]
    else:
