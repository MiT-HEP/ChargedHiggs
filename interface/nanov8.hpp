...
//
#define NANO_V8_MAXELE 10
#define NANO_V8_MAXMUO 10
#define NANO_V8_MAXJET 35
#define NANO_V8_MAXFAT 10
#define NANO_V8_MAXPHO 20
#define NANO_V8_MAXTAU 15
#define NANO_V8_MAXGENFAT 10
#define NANO_V8_MAXGENJET 20
#define NANO_V8_MAXISOTRACK 20

class nanov8 {
public :
   int year=2016;
   int data=false;
   int v9=false; // will become default at a certain point
   ...
   UInt_t          nElectron;
   Float_t         Electron_dEscaleDown[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dEscaleUp[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dEsigmaDown[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dEsigmaUp[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_deltaEtaSC[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dr03EcalRecHitSumEt[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dr03HcalDepth1TowerSumEt[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dr03TkSumPt[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dr03TkSumPtHEEP[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dxy[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dxyErr[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dz[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_dzErr[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_eCorr[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_eInvMinusPInv[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_energyErr[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_eta[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_hoe[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_ip3d[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_jetPtRelv2[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_jetRelIso[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_mass[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_miniPFRelIso_all[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_miniPFRelIso_chg[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_mvaFall17V1Iso[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_mvaFall17V1noIso[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_mvaFall17V2Iso[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_mvaFall17V2noIso[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_pfRelIso03_all[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_pfRelIso03_chg[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_phi[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_pt[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_r9[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_scEtOverPt[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_sieie[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_sip3d[NANO_V8_MAXELE];   //[nElectron]
   Float_t         Electron_mvaTTH[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_charge[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_cutBased[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_cutBased_Fall17_V1[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_jetIdx[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_pdgId[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_photonIdx[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_tightCharge[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmap[NANO_V8_MAXELE];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapHEEP[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_convVeto[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_cutBased_HEEP[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_isPFcand[NANO_V8_MAXELE];   //[nElectron]
   UChar_t         Electron_jetNDauCharged[NANO_V8_MAXELE];   //[nElectron]
   UChar_t         Electron_lostHits[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP80[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP90[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WPL[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP80[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP90[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WPL[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP80[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP90[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WPL[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP80[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP90[NANO_V8_MAXELE];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WPL[NANO_V8_MAXELE];   //[nElectron]
   UChar_t         Electron_seedGain[NANO_V8_MAXELE];   //[nElectron]
   UInt_t          nFatJet;
   Float_t         FatJet_area[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagCMVA[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagCSVV2[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDBvL[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDBvLV2[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDBvL_noMD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDCvB[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDCvBV2[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDCvB_noMD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDCvL[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDCvLV2[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDDCvL_noMD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagDeepB[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_btagHbb[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_H4qvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_HbbvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_TvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_WvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZHbbvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZHccvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZbbvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_bbvsLight[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ccvsLight[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTag_H[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTag_QCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTag_QCDothers[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTag_TvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTag_WvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_deepTag_ZvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_eta[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_mass[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_msoftdrop[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_n2b1[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_n3b1[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNetMD_QCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xbb[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xcc[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xqq[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_H4qvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_HbbvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_HccvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_TvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_WvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_ZvsQCD[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_particleNet_mass[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_phi[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_pt[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_rawFactor[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_tau1[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_tau2[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_tau3[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_tau4[NANO_V8_MAXFAT];   //[nFatJet]
   Float_t         FatJet_lsf3[NANO_V8_MAXFAT];   //[nFatJet]
   Int_t           FatJet_jetId[NANO_V8_MAXFAT];   //[nFatJet]
   Int_t           FatJet_subJetIdx1[NANO_V8_MAXFAT];   //[nFatJet]
   Int_t           FatJet_subJetIdx2[NANO_V8_MAXFAT];   //[nFatJet]
   Int_t           FatJet_electronIdx3SJ[NANO_V8_MAXFAT];   //[nFatJet]
   Int_t           FatJet_muonIdx3SJ[NANO_V8_MAXFAT];   //[nFatJet]
   UChar_t         FatJet_nConstituents[NANO_V8_MAXFAT];   //[nFatJet]
   UInt_t          nFsrPhoton;
   ...
   UInt_t          nGenJetAK8;
   Float_t         GenJetAK8_eta[NANO_V8_MAXGENFAT];   //[nGenJetAK8]
   Float_t         GenJetAK8_mass[NANO_V8_MAXGENFAT];   //[nGenJetAK8]
   Float_t         GenJetAK8_phi[NANO_V8_MAXGENFAT];   //[nGenJetAK8]
   Float_t         GenJetAK8_pt[NANO_V8_MAXGENFAT];   //[nGenJetAK8]
   UInt_t          nGenJet;
   Float_t         GenJet_eta[NANO_V8_MAXGENJET];   //[nGenJet]
   Float_t         GenJet_mass[NANO_V8_MAXGENJET];   //[nGenJet]
   Float_t         GenJet_phi[NANO_V8_MAXGENJET];   //[nGenJet]
   Float_t         GenJet_pt[NANO_V8_MAXGENJET];   //[nGenJet]
   UInt_t          nGenPart;
   ...
   UInt_t          nIsoTrack;
   Float_t         IsoTrack_dxy[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_dz[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_eta[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_phi[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_pt[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Int_t           IsoTrack_charge[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Bool_t          IsoTrack_isHighPurityTrack[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[NANO_V8_MAXISOTRACK];   //[nIsoTrack]
   UInt_t          nJet;
   Float_t         Jet_area[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagCMVA[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagCSVV2[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepB[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepC[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepCvB[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepCvL[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepFlavB[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepFlavC[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_chEmEF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_chFPV0EF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_chFPV1EF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_chFPV2EF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_chFPV3EF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_chHEF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_eta[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_mass[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_muEF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_muonSubtrFactor[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_neEmEF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_neHEF[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_phi[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_pt[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_puIdDisc[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_qgl[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_rawFactor[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_bRegCorr[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_bRegRes[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_cRegCorr[NANO_V8_MAXJET];   //[nJet]
   Float_t         Jet_cRegRes[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_electronIdx1[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_electronIdx2[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_jetId[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_muonIdx1[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_muonIdx2[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_nConstituents[NANO_V8_MAXJET];   //[nJet] // UChar_t in v9?
   Int_t           Jet_nElectrons[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_nMuons[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_puId[NANO_V8_MAXJET];   //[nJet]
   ...
   UChar_t         LHE_NpLO;
   UInt_t          nLHEPart;
   Float_t         LHEPart_pt[20];   //[nLHEPart]
   Float_t         LHEPart_eta[20];   //[nLHEPart]
   Float_t         LHEPart_phi[20];   //[nLHEPart]
   Float_t         LHEPart_mass[20];   //[nLHEPart]
   Float_t         LHEPart_incomingpz[20];   //[nLHEPart]
   Int_t           LHEPart_pdgId[20];   //[nLHEPart]
   Int_t           LHEPart_status[20];   //[nLHEPart]
   Int_t           LHEPart_spin[20];   //[nLHEPart]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   UInt_t          nMuon;
   Float_t         Muon_dxy[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_dxyErr[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_dxybs[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_dz[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_dzErr[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_eta[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_ip3d[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_jetPtRelv2[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_jetRelIso[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_mass[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_miniPFRelIso_all[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_miniPFRelIso_chg[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_pfRelIso03_all[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_pfRelIso03_chg[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_pfRelIso04_all[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_phi[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_pt[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_ptErr[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_segmentComp[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_sip3d[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_softMva[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_tkRelIso[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_tunepRelPt[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_mvaLowPt[NANO_V8_MAXMUO];   //[nMuon]
   Float_t         Muon_mvaTTH[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Muon_charge[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Muon_jetIdx[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Muon_nStations[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Muon_nTrackerLayers[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Muon_pdgId[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Muon_tightCharge[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Muon_fsrPhotonIdx[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_highPtId[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_highPurity[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_inTimeMuon[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_isGlobal[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_isPFcand[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_isStandalone[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_isTracker[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_jetNDauCharged[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_looseId[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_mediumId[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_mediumPromptId[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_miniIsoId[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_multiIsoId[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_mvaId[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_mvaLowPtId[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_pfIsoId[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_puppiIsoId[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_softId[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_softMvaId[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_tightId[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_tkIsoId[NANO_V8_MAXMUO];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[NANO_V8_MAXMUO];   //[nMuon]
   UInt_t          nPhoton;
   Float_t         Photon_dEscaleDown[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_dEscaleUp[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_dEsigmaDown[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_dEsigmaUp[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_eCorr[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_energyErr[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_eta[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_hoe[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_mass[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_mvaID[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_mvaID_Fall17V1p1[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_phi[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_pt[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_r9[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         Photon_sieie[NANO_V8_MAXPHO];   //[nPhoton]
   Int_t           Photon_charge[NANO_V8_MAXPHO];   //[nPhoton]
   Int_t           Photon_cutBased[NANO_V8_MAXPHO];   //[nPhoton]
   Int_t           Photon_cutBased_Fall17V1Bitmap[NANO_V8_MAXPHO];   //[nPhoton]
   Int_t           Photon_electronIdx[NANO_V8_MAXPHO];   //[nPhoton]
   Int_t           Photon_jetIdx[NANO_V8_MAXPHO];   //[nPhoton]
   Int_t           Photon_pdgId[NANO_V8_MAXPHO];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[NANO_V8_MAXPHO];   //[nPhoton]
   Bool_t          Photon_electronVeto[NANO_V8_MAXPHO];   //[nPhoton]
   Bool_t          Photon_isScEtaEB[NANO_V8_MAXPHO];   //[nPhoton]
   Bool_t          Photon_isScEtaEE[NANO_V8_MAXPHO];   //[nPhoton]
   Bool_t          Photon_mvaID_WP80[NANO_V8_MAXPHO];   //[nPhoton]
   Bool_t          Photon_mvaID_WP90[NANO_V8_MAXPHO];   //[nPhoton]
   Bool_t          Photon_pixelSeed[NANO_V8_MAXPHO];   //[nPhoton]
   UChar_t         Photon_seedGain[NANO_V8_MAXPHO];   //[nPhoton]
   ...
   UInt_t          nTau;
   Float_t         Tau_chargedIso[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_dxy[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_dz[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_eta[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_leadTkDeltaEta[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_leadTkDeltaPhi[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_leadTkPtOverTauPt[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_mass[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_neutralIso[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_phi[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_photonsOutsideSignalCone[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_pt[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_puCorr[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawAntiEle[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawAntiEle2018[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSe[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSjet[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSmu[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawIso[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawIsodR03[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawMVAnewDM2017v2[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawMVAoldDM[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v1[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v2[NANO_V8_MAXTAU];   //[nTau]
   Float_t         Tau_rawMVAoldDMdR032017v2[NANO_V8_MAXTAU];   //[nTau]
   Int_t           Tau_charge[NANO_V8_MAXTAU];   //[nTau]
   Int_t           Tau_decayMode[NANO_V8_MAXTAU];   //[nTau]
   Int_t           Tau_jetIdx[NANO_V8_MAXTAU];   //[nTau]
   Int_t           Tau_rawAntiEleCat[NANO_V8_MAXTAU];   //[nTau]
   Int_t           Tau_rawAntiEleCat2018[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idAntiEle[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idAntiEle2018[NANO_V8_MAXTAU];   //[nTau]
   Bool_t          Tau_idAntiEleDeadECal[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idAntiMu[NANO_V8_MAXTAU];   //[nTau]
   Bool_t          Tau_idDecayMode[NANO_V8_MAXTAU];   //[nTau]
   Bool_t          Tau_idDecayModeNewDMs[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSe[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSjet[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSmu[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idMVAnewDM2017v2[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idMVAoldDM[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v1[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v2[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_idMVAoldDMdR032017v2[NANO_V8_MAXTAU];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   ...
   Float_t         GenVtx_t0;
   Int_t           Jet_genJetIdx[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_hadronFlavour[NANO_V8_MAXJET];   //[nJet]
   Int_t           Jet_partonFlavour[NANO_V8_MAXJET];   //[nJet]
   Int_t           Muon_genPartIdx[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Muon_genPartFlav[NANO_V8_MAXMUO];   //[nMuon]
   Int_t           Photon_genPartIdx[NANO_V8_MAXPHO];   //[nPhoton]
   UChar_t         Photon_genPartFlav[NANO_V8_MAXPHO];   //[nPhoton]
   Float_t         MET_fiducialGenPhi;
   Float_t         MET_fiducialGenPt;
   UChar_t         Electron_cleanmask[NANO_V8_MAXELE];   //[nElectron]
   UChar_t         Jet_cleanmask[NANO_V8_MAXJET];   //[nJet]
   UChar_t         Muon_cleanmask[NANO_V8_MAXMUO];   //[nMuon]
   UChar_t         Photon_cleanmask[NANO_V8_MAXPHO];   //[nPhoton]
   UChar_t         Tau_cleanmask[NANO_V8_MAXTAU];   //[nTau]
   ...
   Int_t           Tau_genPartIdx[NANO_V8_MAXTAU];   //[nTau]
   UChar_t         Tau_genPartFlav[NANO_V8_MAXTAU];   //[nTau]
