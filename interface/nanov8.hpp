...
public :
   ...
   UInt_t          nElectron;
   Float_t         Electron_dEscaleDown[30];   //[nElectron]
   Float_t         Electron_dEscaleUp[30];   //[nElectron]
   Float_t         Electron_dEsigmaDown[30];   //[nElectron]
   Float_t         Electron_dEsigmaUp[30];   //[nElectron]
   Float_t         Electron_deltaEtaSC[30];   //[nElectron]
   Float_t         Electron_dr03EcalRecHitSumEt[30];   //[nElectron]
   Float_t         Electron_dr03HcalDepth1TowerSumEt[30];   //[nElectron]
   Float_t         Electron_dr03TkSumPt[30];   //[nElectron]
   Float_t         Electron_dr03TkSumPtHEEP[30];   //[nElectron]
   Float_t         Electron_dxy[30];   //[nElectron]
   Float_t         Electron_dxyErr[30];   //[nElectron]
   Float_t         Electron_dz[30];   //[nElectron]
   Float_t         Electron_dzErr[30];   //[nElectron]
   Float_t         Electron_eCorr[30];   //[nElectron]
   Float_t         Electron_eInvMinusPInv[30];   //[nElectron]
   Float_t         Electron_energyErr[30];   //[nElectron]
   Float_t         Electron_eta[30];   //[nElectron]
   Float_t         Electron_hoe[30];   //[nElectron]
   Float_t         Electron_ip3d[30];   //[nElectron]
   Float_t         Electron_jetPtRelv2[30];   //[nElectron]
   Float_t         Electron_jetRelIso[30];   //[nElectron]
   Float_t         Electron_mass[30];   //[nElectron]
   Float_t         Electron_miniPFRelIso_all[30];   //[nElectron]
   Float_t         Electron_miniPFRelIso_chg[30];   //[nElectron]
   Float_t         Electron_mvaFall17V1Iso[30];   //[nElectron]
   Float_t         Electron_mvaFall17V1noIso[30];   //[nElectron]
   Float_t         Electron_mvaFall17V2Iso[30];   //[nElectron]
   Float_t         Electron_mvaFall17V2noIso[30];   //[nElectron]
   Float_t         Electron_pfRelIso03_all[30];   //[nElectron]
   Float_t         Electron_pfRelIso03_chg[30];   //[nElectron]
   Float_t         Electron_phi[30];   //[nElectron]
   Float_t         Electron_pt[30];   //[nElectron]
   Float_t         Electron_r9[30];   //[nElectron]
   Float_t         Electron_scEtOverPt[30];   //[nElectron]
   Float_t         Electron_sieie[30];   //[nElectron]
   Float_t         Electron_sip3d[30];   //[nElectron]
   Float_t         Electron_mvaTTH[30];   //[nElectron]
   Int_t           Electron_charge[30];   //[nElectron]
   Int_t           Electron_cutBased[30];   //[nElectron]
   Int_t           Electron_cutBased_Fall17_V1[30];   //[nElectron]
   Int_t           Electron_jetIdx[30];   //[nElectron]
   Int_t           Electron_pdgId[30];   //[nElectron]
   Int_t           Electron_photonIdx[30];   //[nElectron]
   Int_t           Electron_tightCharge[30];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmap[30];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapHEEP[30];   //[nElectron]
   Bool_t          Electron_convVeto[30];   //[nElectron]
   Bool_t          Electron_cutBased_HEEP[30];   //[nElectron]
   Bool_t          Electron_isPFcand[30];   //[nElectron]
   UChar_t         Electron_jetNDauCharged[30];   //[nElectron]
   UChar_t         Electron_lostHits[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP80[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP90[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WPL[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP80[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP90[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WPL[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP80[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP90[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WPL[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP80[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP90[30];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WPL[30];   //[nElectron]
   UChar_t         Electron_seedGain[30];   //[nElectron]
   UInt_t          nFatJet;
   Float_t         FatJet_area[20];   //[nFatJet]
   Float_t         FatJet_btagCMVA[20];   //[nFatJet]
   Float_t         FatJet_btagCSVV2[20];   //[nFatJet]
   Float_t         FatJet_btagDDBvL[20];   //[nFatJet]
   Float_t         FatJet_btagDDBvLV2[20];   //[nFatJet]
   Float_t         FatJet_btagDDBvL_noMD[20];   //[nFatJet]
   Float_t         FatJet_btagDDCvB[20];   //[nFatJet]
   Float_t         FatJet_btagDDCvBV2[20];   //[nFatJet]
   Float_t         FatJet_btagDDCvB_noMD[20];   //[nFatJet]
   Float_t         FatJet_btagDDCvL[20];   //[nFatJet]
   Float_t         FatJet_btagDDCvLV2[20];   //[nFatJet]
   Float_t         FatJet_btagDDCvL_noMD[20];   //[nFatJet]
   ...
   Float_t         FatJet_deepTag_H[20];   //[nFatJet]
   Float_t         FatJet_deepTag_QCD[20];   //[nFatJet]
   Float_t         FatJet_deepTag_QCDothers[20];   //[nFatJet]
   ...
   Float_t         FatJet_particleNetMD_QCD[20];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xbb[20];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xcc[20];   //[nFatJet]
   Float_t         FatJet_particleNetMD_Xqq[20];   //[nFatJet]
   Float_t         FatJet_particleNet_H4qvsQCD[20];   //[nFatJet]
   Float_t         FatJet_particleNet_HbbvsQCD[20];   //[nFatJet]
   Float_t         FatJet_particleNet_HccvsQCD[20];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD[20];   //[nFatJet]
   Float_t         FatJet_particleNet_TvsQCD[20];   //[nFatJet]
   Float_t         FatJet_particleNet_WvsQCD[20];   //[nFatJet]
   Float_t         FatJet_particleNet_ZvsQCD[20];   //[nFatJet]
   Float_t         FatJet_particleNet_mass[20];   //[nFatJet]
   ...
   Float_t         FatJet_lsf3[20];   //[nFatJet]
   Int_t           FatJet_jetId[20];   //[nFatJet]
   Int_t           FatJet_subJetIdx1[20];   //[nFatJet]
   Int_t           FatJet_subJetIdx2[20];   //[nFatJet]
   Int_t           FatJet_electronIdx3SJ[20];   //[nFatJet]
   Int_t           FatJet_muonIdx3SJ[20];   //[nFatJet]
   UChar_t         FatJet_nConstituents[20];   //[nFatJet]
   UInt_t          nFsrPhoton;
   ...
   Int_t           IsoTrack_charge[100];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[100];   //[nIsoTrack]
   ...
   Float_t         Jet_btagDeepCvB[80];   //[nJet]
   Float_t         Jet_btagDeepCvL[80];   //[nJet]
   Float_t         Jet_btagDeepFlavB[80];   //[nJet]
   Float_t         Jet_btagDeepFlavC[80];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[80];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[80];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[80];   //[nJet]
   Float_t         Jet_chEmEF[80];   //[nJet]
   Float_t         Jet_chFPV0EF[80];   //[nJet]
   Float_t         Jet_chFPV1EF[80];   //[nJet]
   Float_t         Jet_chFPV2EF[80];   //[nJet]
   Float_t         Jet_chFPV3EF[80];   //[nJet]
   Float_t         Jet_chHEF[80];   //[nJet]
   Float_t         Jet_eta[80];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[80];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[80];   //[nJet]
   Float_t         Jet_mass[80];   //[nJet]
   Float_t         Jet_muEF[80];   //[nJet]
   Float_t         Jet_muonSubtrFactor[80];   //[nJet]
   Float_t         Jet_neEmEF[80];   //[nJet]
   Float_t         Jet_neHEF[80];   //[nJet]
   Float_t         Jet_phi[80];   //[nJet]
   Float_t         Jet_pt[80];   //[nJet]
   Float_t         Jet_puIdDisc[80];   //[nJet]
   Float_t         Jet_qgl[80];   //[nJet]
   Float_t         Jet_rawFactor[80];   //[nJet]
   Float_t         Jet_bRegCorr[80];   //[nJet]
   Float_t         Jet_bRegRes[80];   //[nJet]
   Float_t         Jet_cRegCorr[80];   //[nJet]
   Float_t         Jet_cRegRes[80];   //[nJet]
   Int_t           Jet_electronIdx1[80];   //[nJet]
   Int_t           Jet_electronIdx2[80];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[80];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[80];   //[nJet]
   Int_t           Jet_jetId[80];   //[nJet]
   Int_t           Jet_muonIdx1[80];   //[nJet]
   Int_t           Jet_muonIdx2[80];   //[nJet]
   Int_t           Jet_nConstituents[80];   //[nJet] // UChar_t in v9?
   ...
   Float_t         Muon_mvaTTH[30];   //[nMuon]
   Int_t           Muon_charge[30];   //[nMuon]
   Int_t           Muon_jetIdx[30];   //[nMuon]
   Int_t           Muon_nStations[30];   //[nMuon]
   Int_t           Muon_nTrackerLayers[30];   //[nMuon]
   Int_t           Muon_pdgId[30];   //[nMuon]
   Int_t           Muon_tightCharge[30];   //[nMuon]
   Int_t           Muon_fsrPhotonIdx[30];   //[nMuon]
   ...
   UChar_t         Muon_mvaId[30];   //[nMuon]
   UChar_t         Muon_mvaLowPtId[30];   //[nMuon]
   ...
   UInt_t          nPhoton;
   Float_t         Photon_dEscaleDown[40];   //[nPhoton]
   Float_t         Photon_dEscaleUp[40];   //[nPhoton]
   Float_t         Photon_dEsigmaDown[40];   //[nPhoton]
   Float_t         Photon_dEsigmaUp[40];   //[nPhoton]
   ...
   Float_t         Photon_mvaID_Fall17V1p1[40];   //[nPhoton]
   ...
   Int_t           Photon_cutBased_Fall17V1Bitmap[40];   //[nPhoton]
   ...
   UChar_t         Photon_seedGain[40];   //[nPhoton]
   ...
   Bool_t          Tau_idAntiEleDeadECal[15];   //[nTau]
   ...
   UChar_t         Electron_cleanmask[30];   //[nElectron]
   UChar_t         Jet_cleanmask[80];   //[nJet]
   UChar_t         Muon_cleanmask[30];   //[nMuon]
