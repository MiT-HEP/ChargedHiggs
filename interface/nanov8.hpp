...
public :
   ...
   Float_t         Jet_btagDeepCvB[100];   //[nJet]
   Float_t         Jet_btagDeepCvL[100];   //[nJet]
   Float_t         Jet_btagDeepFlavB[100];   //[nJet]
   Float_t         Jet_btagDeepFlavC[100];   //[nJet]
   ...
   Float_t         Jet_chFPV0EF[100];   //[nJet]
   Float_t         Jet_chFPV1EF[100];   //[nJet]
   Float_t         Jet_chFPV2EF[100];   //[nJet]
   Float_t         Jet_chFPV3EF[100];   //[nJet]
   ...
   Float_t         Jet_cRegCorr[100];   //[nJet]
   Float_t         Jet_cRegRes[100];   //[nJet]
   ...
   Int_t           Jet_nConstituents[100];   //[nJet] // UChar_t in v9?
   ...
   Int_t           Muon_jetIdx[40];   //[nMuon]
   Int_t           Muon_nStations[40];   //[nMuon]
   Int_t           Muon_nTrackerLayers[40];   //[nMuon]
   Int_t           Muon_pdgId[40];   //[nMuon]
   Int_t           Muon_tightCharge[40];   //[nMuon]
   Int_t           Muon_fsrPhotonIdx[40];   //[nMuon]
   ...
   UChar_t         Muon_mvaId[40];   //[nMuon]
   UChar_t         Muon_mvaLowPtId[40];   //[nMuon]
