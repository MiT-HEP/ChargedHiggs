...
class CutSelector{
    ...
    public:
        ...
        bool passMask(const size_t i) const  { return !( ~cut_ & mask_ & i );} // apply mask anyway, for consistency
        inline bool passMask(const CutSelector mask) const { return passMask(mask.raw() ) ; }
