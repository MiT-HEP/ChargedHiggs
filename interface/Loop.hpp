...
class Looper{
    ...
    public:
        ...
        inline void AddPtEtaRunSF( string label, double pt1,double pt2 ,double eta1 ,double eta2,unsigned long run1, unsigned long run2,double sf, double err)
        {event_ -> GetWeight()  -> AddPtEtaRunSF(label,pt1,pt2,eta1,eta2,run1,run2,sf,err); }
