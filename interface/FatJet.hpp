...
class FatJet : virtual public Object, virtual public SmearableBase
{
    ...
    inline int IsWJetMirror() const { if( Pt() > 200. and SDMass() > 65. and SDMass() < 105. and WvsQCDMD > 0. and WvsQCDMD < 0.8  and IsFatJet())   return 1; return 0;}
    inline int IsZbbJetMirror() const { if( Pt() > 200. and SDMass() > 75. and SDMass() < 105. and ZHbbvsQCDMD > 0. and ZHbbvsQCDMD < 0.9 and IsFatJet() )   return 1; return 0;}
