...
void makeTable( int LepCat=0 ) {
  ...
  fileName="DEC19/1l.root";
  if(LepCat==1 || LepCat==2 || LepCat==4) fileName="DEC19/2l.root";
...
void dataMCstack() {
  ...
  c = dataMCstackPlot("minDRbb_mass_",dirName,false,lepCat,"highMTCR");
