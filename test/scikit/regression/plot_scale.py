...
pt_eta = ROOT.TProfile2D("prof","prof;Residual;p_{T}^{#muon};#eta^{#muon}",100,0,200,100,-2.5,2.5)
eta_phi = ROOT.TProfile2D("prof","prof;Residual;#eta^{#muon};#phi^{#muon}",100,-2.5,2.5,100,-3.1415,3.1415)
